$(document).ready(function(){
    $("#btn-send-prodenq").click(function(){
   ...
   $.ajax({url:'email-productenquiry.php',
          data:{'txtprodName':$txtprodName,'txtName':$txtname,'txtContactnum':$txtcontactnum,'txtEmail':$txtemail,'txtAddress':$txtaddress,'txtRemark':$txtremark},
          dataType:'json',
          type:'post',
