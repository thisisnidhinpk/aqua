<?php
   include_once("../config.php");
    ...
    $action_name="SAVE";$bannerId='';

    if(isset($_GET['id']))
    {
        $bannerId=$_GET['id'];
        $bannerOptions=" and id= ".$bannerId;
        $productDet = array();
        $productDet = $userObj1->getBanner($bannerOptions);
...
<div class="span9">
	<div class="tab-content">
		<div class="tab-pane active" id="tabPageEmployee">
            ...
            <a href="?p=banner&n=new"><button class="btn btn-small btn-primary">Add New <i class="fa fa-plus"></i></button></a>
            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $i; ?></td>
                          <td><img src="../uploads/banner/<?= $listDet['image']; ?>" height="50px"></td>
                        <td>
                             

                                <a href="?p=banner&n=new&id=<?php echo $tid; ?>" class="updateButtonP" ">
                                ...
                                <a href="?p=deleteData&table=tbl_banner&id=<?php echo $tid; ?>&return=banner" onclick="return confirm('Are you sure, want to delete banner')" class="deleteButtonP" >
