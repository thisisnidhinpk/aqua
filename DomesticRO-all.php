...
<script src="custom-scripts/domusticRO-all.js"></script>
...
<?php
		 $result = $conn->query("SELECT * FROM tbl_products where Prod_catagory=1"); 
	?>
...
<div class="check" id="">
	...
	<tr>
	<td></td>
	<td><button class="acount-btn" id="myBtn" data-prodname="<?php echo $row['Prod_name']; ?>">Send Enquiry</button></td>
	</tr>
	</tbody>
	</table>
	</div>
